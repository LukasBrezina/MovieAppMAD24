...
import com.example.movieappmad24.BottomNavigationItem
...
@Composable
fun HomeScreen(navigationItems: List<BottomNavigationItem> = getNavigationItems(), navController: NavController) {
    ...
    ) { paddingValues -> MovieList(movieList = getMovies(), paddingValues, navController) }
}
